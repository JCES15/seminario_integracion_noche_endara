...
interface Empleados {
    ...
    cedula: number;
    descripcion?: string;  
 } // texto largo, no siempre presente

function mostrarDatos(p: Empleados): void {
    
    console.log(`[${p.sku}] ${p.nombre} ${p.cedula})`);
};
const Persona1: Empleados = {
    sku: "001",
    nombre: "Juan Endara",
    cedula: 1710254788,
    descripcion: "PGuardia, Seguridad",
}

const Persona2: Empleados = {
    sku: "002",
    nombre: "Maria Suarez",
    cedula: 1547896544,
